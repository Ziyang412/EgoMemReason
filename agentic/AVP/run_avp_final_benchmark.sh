...
SCRIPT="${SCRIPT_DIR}/eval_agentic_gemini.py"
MERGE_SCRIPT="${SCRIPT_DIR}/../Gemini/merge_temporal_ordering_eval_shards.py"
...
RUN_NAME="final_benchmark_500_apr22_gemini_3_flash_agentic_3rounds_budget1024"
...
TOTAL_FRAME_BUDGET="${TOTAL_FRAME_BUDGET:-1024}"
