#!/usr/bin/env bash
# Qwen3-VL-8B 256f on final_benchmark_500_apr22.json with SHORT per-split instructions.
...
EXP_NAME="apr22_8b_per_split_short_${MAX_FRAMES}f"
...
echo "=== Qwen3-VL-8B per-split SHORT instructions on GPUs ${GPU_GROUPS} ==="
